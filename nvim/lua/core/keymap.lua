...
map_cu("n", "<leader>gr", "Telescope lsp_references theme=cursor", opt)
map_cu("n", "<leader>gf", "Telescope lsp_document_symbols theme=cursor", opt)
map_cu("n", "<leader>gff", "Telescope lsp_workspace_symbols theme=cursor", opt)
map_cu("n", "<leader>gd", "Telescope lsp_definitions theme=cursor", opt)
